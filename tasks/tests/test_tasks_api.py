...
class TestTaskAPI:
    ...
    def test_GET_task_detail_api_valid_response_200(self,authenticated_client,fake_task):
    ...
    def test_PATCH_task_detail_valid_response_200(self,authenticated_client,fake_task):
        url = reverse('tasks:api-v1:tasks-detail',kwargs={'pk':fake_task.pk})
    ...
    def test_DELETE_task_detail_valid_response_204(self,authenticated_client,fake_task):
        url = reverse('tasks:api-v1:tasks-detail',kwargs={'pk':fake_task.pk})
    ...
    def test_PUT_task_detail_invalid_response_400(self,authenticated_client,fake_task):
        url = reverse('tasks:api-v1:tasks-detail',kwargs={'pk':fake_task.pk})
        response = authenticated_client.put(url,data={
            'title':'edited',
            'status':True
    ...
    def test_PATCH_task_detail_invalid_response_400(self,authenticated_client,fake_task):
        url = reverse('tasks:api-v1:tasks-detail',kwargs={'pk':fake_task.pk})
        response = authenticated_client.patch(url,data={
            "title":"a"*51
        })
